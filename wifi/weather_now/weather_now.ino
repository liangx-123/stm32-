...
const char* ssid     = "MEIZU M15";       // 连接WiFi名（此处使用taichi-maker为示例）
                                            // 请将您需要连接的WiFi名填入引号中
const char* password = "123456789";          // 连接WiFi密码（此处使用12345678为示例）                                         // 请将您需要连接的WiFi密码填入引号中
                                            // 请将您需要连接的WiFi密码填入引号中
...
const char* reqUserKey = "SdZg1AqGwilszxuGQ";   // 私钥
const char* reqLocation = "nantong";            // 城市，可使用"ip"自动识别请求 IP 地址
